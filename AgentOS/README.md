# Zo ↔ Antigravity ↔ AgentOS 3-Way MCP Mesh

This is a premium, symmetric, 3-node **Model Context Protocol (MCP) mesh** connecting Zo.Computer, Antigravity IDE, and AgentOS into a unified autonomous workspace.
...
3. **Connect peers**:
   ...
   - **AgentOS**: Register via `register_peer` tool using `mcp_config_agentos.json`.
