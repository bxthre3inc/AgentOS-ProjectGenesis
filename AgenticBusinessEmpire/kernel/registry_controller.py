"""
registry_controller.py — AgenticBusinessEmpire Multi-Tenant Security Registry
...
AgenticBusinessEmpire components.

Permission model
----------------
  tenant_zero  (AgenticBusinessEmpire Internal): ROOT — full read/write everywhere.
...
logger = logging.getLogger("agenticbusinessempire.registry")
...
class PermissionRule:
    tenant_id:  str
    path_prefix: str      # relative to AGENTIC_BUSINESS_EMPIRE root
    read:        bool
    write:       bool
...
_RULES: list[PermissionRule] = [
    ...
    PermissionRule("product_alpha",   "AgenticBusinessEmpire/tenants/starting5/src",       read=True,  write=True,
                   reason="Starting5 owns its source directory."),
    PermissionRule("product_alpha",   "AgenticBusinessEmpire/tenants/starting5/dist",      read=True,  write=True,
                   reason="Starting5 owns its distribution directory."),
    PermissionRule("product_alpha",   "AgenticBusinessEmpire/tenants/starting5/ui",        read=True,  write=True,
                   reason="Starting5 owns its UI directory."),
    PermissionRule("product_alpha",   "AgenticBusinessEmpire/tenants/starting5/sandbox",   read=True,  write=True,
                   reason="Starting5 owns its sandbox."),
    # Explicit denials (checked before generic deny)
    PermissionRule("product_alpha",   "AgenticBusinessEmpire/tenants/agenticbusinessempire_internal",    read=False, write=False,
                   reason="Starting5 must NOT access the Bxthre3 Master Ledger."),
    PermissionRule("product_alpha",   "AgenticBusinessEmpire/kernel",                      read=False, write=False,
                   reason="Starting5 must NOT access AgenticBusinessEmpire kernel internals."),
    PermissionRule("product_alpha",   "AgenticBusinessEmpire/tenants/irrig8",              read=False, write=False,
                   reason="Starting5 must NOT access Irrig8 data."),

    # ── Subsidiary Beta (Irrig8) ──────────────────────────────────────────
    PermissionRule("subsidiary_beta", "AgenticBusinessEmpire/tenants/irrig8",              read=True,  write=True,
                   reason="Irrig8 owns its full tenant directory."),
    PermissionRule("subsidiary_beta", "AgenticBusinessEmpire/runtime/tasks",               read=True,  write=True,
                   reason="Irrig8 may read/write TCOs (for worksheet triggers)."),
    # Explicit denials
    PermissionRule("subsidiary_beta", "AgenticBusinessEmpire/tenants/agenticbusinessempire_internal",    read=False, write=False,
                   reason="Irrig8 must NOT access the Bxthre3 Master Ledger."),
    PermissionRule("subsidiary_beta", "AgenticBusinessEmpire/kernel",                      read=False, write=False,
                   reason="Irrig8 must NOT access AgenticBusinessEmpire kernel internals."),
    PermissionRule("subsidiary_beta", "AgenticBusinessEmpire/tenants/starting5",           read=False, write=False,
...
class RegistryController:
    """Enforces multi-tenant R/W access control on all AgenticBusinessEmpire paths."""
