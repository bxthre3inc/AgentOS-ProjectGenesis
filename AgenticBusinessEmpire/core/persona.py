"""
persona.py — AgenticBusinessEmpire Autonomous Personas
...
_PERSONAS = {
    ...
    "default": "You are an AgenticBusinessEmpire Autonomous Agent. Focus on efficiency and silicon-speed task completion."
}
