...
in an isolated environment. It does NOT import from AgenticBusinessEmpire kernel.
"""
...
from AgenticBusinessEmpire.tenants.starting5.src.roster_controller import create_default_bus, A2AMessage
