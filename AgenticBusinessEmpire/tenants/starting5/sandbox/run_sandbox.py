...
Usage
-----
    python3 AgenticBusinessEmpire/tenants/starting5/sandbox/run_sandbox.py
    python3 AgenticBusinessEmpire/tenants/starting5/sandbox/run_sandbox.py --goal "write a report about crop yields"
"""
