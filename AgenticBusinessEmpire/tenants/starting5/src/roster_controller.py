...
Implements two key agent positions with full A2A (Agent-to-Agent) messaging:
  ...
  Point Guard (PG) — Primary Goal Dispatcher
    ...
    NEVER exposes AgenticBusinessEmpire kernel internals to downstream agents.
...
No agent in Starting5 ever imports from AgenticBusinessEmpire kernel.
"""
...
class PointGuard:
    ...
    It NEVER surfaces AgenticBusinessEmpire kernel objects.
    """
